    ...
    onPluginInit({ addPlugin }) {
      ...
      addPlugin(
        usePersistedOperations({
          ...
          customErrors: {
            keyNotFound() {
              throw new GraphQLError('Failed extracting persisted document.', {});
            },
            notFound() {
              throw new GraphQLError('Persisted document not found.', {});
            },
            persistedQueryOnly() {
              throw new GraphQLError('Only persisted documents are allowed.', {});
            },
          },
        }),
      );
